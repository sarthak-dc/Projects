...
builder.Services.AddDbContext<SpeciesContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("SpeciesContext") ?? throw new InvalidOperationException("Connection string 'SpeciesContext' not found.")));

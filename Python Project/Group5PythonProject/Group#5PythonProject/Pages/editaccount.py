#this is the class editacount page create for the final project.
#date 13th december 2022
class EditAccountPageElement:
    ...
    def enter_customer_id(self, customer_id):
        self.driver.find_element_by_id(self.customer_id_textbox_id).clear()
    ...
    def enter_initial_deposit(self, initial_deposit):
        self.driver.find_element_by_id(self.initial_deposit_textbox_id).clear()
